...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::share('input_css', 'w-full p-2 rounded text-black bg-white disabled:opacity-75 disabled:cursor-not-allowed');
        View::share('link_css', 'text-blue-700 dark:text-blue-300 underline');
    }
}
