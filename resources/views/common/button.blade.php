...
@endisset @else <button
    ...
    class="bg-black/10 dark:bg-white/50 hover:bg-black/15 hover:dark:bg-white/15 hover:dark:text-white px-6 py-2 rounded font-semibold text-gray-900 text-center text-nowrap"
